...
public class FileIOTool {
    ...
    public static boolean writeFileFromIS(File file, InputStream is, boolean append) {
        if (!FileTool.isExist(file) || is == null) {
            return false;
        }
    ...
    public static boolean writeFileFromBytesByStream(File file, byte[] bytes, boolean append) {
        if (bytes == null || !FileTool.isExist(file)) {
            return false;
        }
     ...
     * @return {@code true}: 写入成功<br>{@code false}: 写入失败
     */
    public static boolean writeFileFromBytesByChannel(String filePath, byte[] bytes, boolean
            isForce) {
