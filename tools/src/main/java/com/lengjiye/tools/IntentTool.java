...
public class IntentTool {
    ...
    public static Intent getInstallAppIntent(Context context, String filePath, String authority) {
        return getInstallAppIntent(context, FileTool.getFileByPath(filePath), authority);
    }
    ...
    public static Intent getShareImageIntent(String content, String imagePath) {
        return getShareImageIntent(content, FileTool.getFileByPath(imagePath));
    }
    ...
    public static Intent getShareImageIntent(String content, File image) {
        if (!FileTool.isFile(image)) return null;
